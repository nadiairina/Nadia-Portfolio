...
// Enhanced hover effects para botão de manutenção
function addMaintenanceButtonEffects() {
    const maintenanceButtons = document.querySelectorAll('.maintenance-plan-button, .monthly-plan-button, .plan-button');
...
// Icon hover effects
function addIconHoverEffects() {
    const icons = document.querySelectorAll('.include-icon, .support-icon');
